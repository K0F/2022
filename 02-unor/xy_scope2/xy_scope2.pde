...
*/
  ...
  for(int i = 1; i < in.bufferSize()-1; i++)
  {
    ...
    float theta1 = cos(ampl1*TWO_PI)*AMP;
    float theta2 = sin(ampr1*TWO_PI)*AMP;
    float theta3 = cos(ampl2*TWO_PI)*AMP;
    float theta4 = sin(ampr2*TWO_PI)*AMP;
    float l1 = theta1;
    float r1 = theta2;
    float l2 = theta3;
    float r2 = theta4;
